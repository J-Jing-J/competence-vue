...
<!--      <el-button type="primary" @click="handleAdd">新增 <i class="el-icon-circle-plus-outline"></i></el-button>-->
      ...
      <!-- <el-upload action="http://114.132.74.153:9090/sign/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open("http://114.132.74.153:9090/sign/export")
    },
