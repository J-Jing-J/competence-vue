<template>
    <div style="margin-bottom: 100px;">
		<div style="margin-top: 20px">
  		  <el-radio-group v-model="orderRadio" size="small">
  		    <el-radio-button label="第一次" ></el-radio-button>
  		    <el-radio-button label="第二次"></el-radio-button>
  		    <el-radio-button label="第三次"></el-radio-button>
  		    <el-radio-button label="第四次"></el-radio-button>
  		    <el-radio-button label="第五次"></el-radio-button>
  		    <el-radio-button label="第六次"></el-radio-button>
  		    <el-radio-button label="第七次"></el-radio-button>
  		    <el-radio-button label="第八次"></el-radio-button>
  		    <el-radio-button label="第九次"></el-radio-button>
  		    <el-radio-button label="第十次"></el-radio-button>
  		  </el-radio-group>
  		</div>
	  <el-descriptions style="margin: 20px 0; font-size: 20px; color: #1E90FF" title="射击详情" size="large">
    	<el-descriptions-item label="枪支">{{gunType}}</el-descriptions-item>
	    <el-descriptions-item label="得分">
	      <el-tag size="small">{{thisScore.toFixed(1)}}</el-tag>
	    </el-descriptions-item>
	    <el-descriptions-item label="总得分">{{totalScore.toFixed(1)}}</el-descriptions-item>
	    <el-descriptions-item label="平均得分">{{averageScore.toFixed(1)}}</el-descriptions-item>
	    <el-descriptions-item label="击发时间">{{shootTime}}</el-descriptions-item>
	    <el-descriptions-item label="方位">{{shootDirection}}</el-descriptions-item>
	</el-descriptions>
      <div style="border: 1px solid #ccc; padding: 10px; border-radius: 10px; margin: 10px 0">
        <div id="trackChart" style="width: 800px; height: 450px"></div>
      </div>
      <div style="border: 1px solid #ccc; padding: 10px; border-radius: 10px; margin: 10px 0">
        <div id="pressureChart" style="width: 800px; height: 450px"></div>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    mounted() {
        setTimeout(() => {
            var trackChartDom = document.getElementById('trackChart');
            var trackChart = echarts.init(trackChartDom);
            var trackChartOption;

// this.request.get(ROOT_PATH + '/data/asset/data/life-expectancy-table.json').then(res => {
    const res = [
	...
	[1244, 36.5731262, 977662, "Deviation", 1800],
	...
	[1267, 36.9473378, 1070625, "Deviation", 1810],
	...
	[1290, 37.29122269, 1190807, "Deviation", 1820],
	...
	[1360, 36.29644969, 1327905, "Deviation", 1830],
	...
	[1434, 41.46900965, 1467238, "Deviation", 1840],
	...
	[1512, 37.35415172, 1607810, "Deviation", 1850],
	...
	[1594, 38.15099864, 1734254, "Deviation", 1860],
	...
	[1897, 45.66140699, 1847468, "Deviation", 1870],
	...
	[1925, 39.67, 2047577, "Deviation", 1880],
	...
	[2305, 44.61, 2358344, "Deviation", 1890],
	...
	[2789, 41.8, 2633389, "Deviation", 1900],
	...
	[3192, 48.53, 2930441, "Deviation", 1910],
	...
	[3097, 47.55, 3140763, "Deviation", 1920],
	...
	[4489, 54.438, 3450505, "Deviation", 1930],
	...
	[5439, 46.586, 3696232, "Deviation", 1940],
	...
	[7198, 64.144, 4008299, "Deviation", 1950],
	...
	[7738, 65.5708, 4049689, "Deviation", 1951],
	...
	[7914, 66.4476, 4095130, "Deviation", 1952],
	...
	[7877, 66.5044, 4142353, "Deviation", 1953],
	...
	[8470, 67.4612, 4189559, "Deviation", 1954],
	...
	[8802, 67.258, 4235423, "Deviation", 1955],
	...
	[8971, 67.8748, 4279108, "Deviation", 1956],
	...
	[9302, 67.3716, 4320250, "Deviation", 1957],
	...
	[9276, 68.5084, 4358901, "Deviation", 1958],
	...
	[9751, 68.6852, 4395427, "Deviation", 1959],
	...
	[10560, 68.882, 4430228, "Deviation", 1960],
	...
	[11286, 68.9088, 4463432, "Deviation", 1961],
	...
	[11560, 68.6156, 4494623, "Deviation", 1962],
	...
	[11858, 69.0224, 4522727, "Deviation", 1963],
	...
	[12389, 69.2292, 4546343, "Deviation", 1964],
	...
	[13006, 68.986, 4564690, "Deviation", 1965],
	...
	[13269, 69.5028, 4577033, "Deviation", 1966],
	...
	[13477, 69.6796, 4584264, "Deviation", 1967],
	...
	[13726, 69.6364, 4589226, "Deviation", 1968],
	...
	[15058, 69.5132, 4595807, "Deviation", 1969],
	...
	[16245, 70.2, 4606740, "Deviation", 1970],
	...
	[16564, 70.5, 4623389, "Deviation", 1971],
	...
	[17722, 70.9, 4644847, "Deviation", 1972],
	...
	[18804, 71.3, 4668813, "Deviation", 1973],
	...
	[19273, 71.4, 4691818, "Deviation", 1974],
	...
	[19409, 71.6, 4711459, "Deviation", 1975],
	...
	[19268, 72, 4726803, "Deviation", 1976],
	...
	[19261, 72.4, 4738949, "Deviation", 1977],
	...
	[19608, 72.9, 4749940, "Deviation", 1978],
	...
	[20918, 73.3, 4762758, "Deviation", 1979],
	...
	[21965, 73.7, 4779454, "Deviation", 1980],
	...
	[22279, 74, 4800899, "Deviation", 1981],
	...
	[22873, 74.3, 4826135, "Deviation", 1982],
	...
	[23351, 74.5, 4853196, "Deviation", 1983],
	...
	[23926, 74.6, 4879222, "Deviation", 1984],
	...
	[24630, 74.7, 4902219, "Deviation", 1985],
	...
	[25133, 74.7, 4921293, "Deviation", 1986],
	...
	[26086, 74.7, 4937259, "Deviation", 1987],
	...
	[27282, 74.8, 4951886, "Deviation", 1988],
	...
	[28735, 74.8, 4967776, "Deviation", 1989],
	...
	[28599, 75, 4986705, "Deviation", 1990],
	...
	[26761, 75.4, 5009381, "Deviation", 1991],
	...
	[25726, 75.8, 5034898, "Deviation", 1992],
	...
	[25414, 76.2, 5061465, "Deviation", 1993],
	...
	[26301, 76.5, 5086499, "Deviation", 1994],
	...
	[27303, 76.7, 5108176, "Deviation", 1995],
	...
	[28210, 76.9, 5126021, "Deviation", 1996],
	...
	[29884, 77.1, 5140755, "Deviation", 1997],
	...
	[31423, 77.3, 5153229, "Deviation", 1998],
	...
	[32743, 77.5, 5164780, "Deviation", 1999],
	...
	[34517, 77.8, 5176482, "Deviation", 2000],
	...
	[35327, 78.2, 5188446, "Deviation", 2001],
	...
	[35834, 78.5, 5200632, "Deviation", 2002],
	...
	[36461, 78.6, 5213800, "Deviation", 2003],
	...
	[37783, 78.6, 5228842, "Deviation", 2004],
	...
	[38700, 78.8, 5246368, "Deviation", 2005],
	...
	[40115, 79, 5266600, "Deviation", 2006],
	...
	[42016, 79.2, 5289333, "Deviation", 2007],
	...
	[42122, 79.4, 5314170, "Deviation", 2008],
	...
	[38455, 79.7, 5340485, "Deviation", 2009],
	...
	[39425, 80, 5367693, "Deviation", 2010],
	...
	[40251, 80.3, 5395816, "Deviation", 2011],
	...
	[39489, 80.5, 5424644, "Deviation", 2012],
	...
	[38788, 80.6, 5453061, "Deviation", 2013],
	...
	[38569, 80.7, 5479660, "Deviation", 2014],
	...
	[38923, 80.8, 5503457, "Deviation", 2015],
...
function run(_rawData) {
  ...
  trackChart.setOption(trackChartOption);
}
...
option && myChart.setOption(option);
		...
		var pressureChart = echarts.init(pressureChartDom);
		...
		pressureChartOption && pressureChart.setOption(pressureChartOption);
